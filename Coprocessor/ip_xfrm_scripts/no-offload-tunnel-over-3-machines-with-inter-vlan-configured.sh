...
for i in {1..2}; do
 ...
 ip xfrm state add src 20.1.1.21 dst 50.1.1.196 proto esp spi 0x${spi[1]} reqid 0x${reqid[1]} mode tunnel aead "rfc4106(gcm(aes))" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 
...
for i in {1..2}; do
 ...
 ip xfrm state add src 20.1.1.21 dst 30.1.1.96 proto esp spi 0x${spi[1]} reqid 0x${reqid[1]} mode tunnel aead "rfc4106(gcm(aes))" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 
...
ssh viper1 " ip xfrm state add src 30.1.1.96 dst 20.1.1.21 proto esp spi 0x${spi[2]} reqid 0x${reqid[2]} mode tunnel aead \"rfc4106(gcm(aes))\" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 "
...
for i in {1..2}; do
 ...
 ip xfrm state add src 20.2.2.21 dst 50.2.2.196 proto esp spi 0x${spi[1]} reqid 0x${reqid[1]} mode tunnel aead "rfc4106(gcm(aes))" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 
...
for i in {1..2}; do
 ...
 ip xfrm state add src 20.2.2.21 dst 30.2.2.96 proto esp spi 0x${spi[1]} reqid 0x${reqid[1]} mode tunnel aead "rfc4106(gcm(aes))" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 
...
ssh viper1 " ip xfrm state add src 30.2.2.96 dst 20.2.2.21 proto esp spi 0x${spi[2]} reqid 0x${reqid[2]} mode tunnel aead \"rfc4106(gcm(aes))\" 0x010203047aeaca3f87d060a12f4a4487d5a5c335 96 sel src 0.0.0.0/0 dst 0.0.0.0/0 "
